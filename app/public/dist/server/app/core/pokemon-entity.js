...
class PokemonEntity extends schema_1.Schema {
    ...
    removeItemEffect(item) {
        ...
        if (type && !default_types.includes(type)) {
            ...
            Synergy_1.SynergyEffects[type].forEach((effectName) => {
    ...
    onAttack({ target, board, physicalDamage, specialDamage, trueDamage, totalDamage }) {
        ...
        if (target.effects.has(Effect_1.Effect.OBSTRUCT)) {
    ...
    onHit({ target, board, totalTakenDamage, physicalDamage, specialDamage, trueDamage }) {
        ...
        this.effectsSet.forEach((effect) => {
            if (effect instanceof effect_1.OnHitEffect) {
                effect.apply(this, target, board);
            }
        });
        ...
        if (this.types.has(Synergy_1.Synergy.GHOST)) {
    ...
    onKill({ target, board }) {
        ...
        if (this.player &&
            this.simulation.room.state.specialGameRule === SpecialGameRule_1.SpecialGameRule.BLOOD_MONEY) {
    ...
    resurrect() {
        ...
        const stackingItems = [Item_1.Item.DEFENSIVE_RIBBON, Item_1.Item.SOUL_DEW, Item_1.Item.UPGRADE, Item_1.Item.MAGMARIZER];
        ...
        const resetSoundStacks = (effect) => {
            var _a, _b, _c;
            const synergyLevel = Synergy_1.SynergyEffects[Synergy_1.Synergy.SOUND].indexOf(effect);
            const attackBoost = ((_a = [2, 1, 1][synergyLevel]) !== null && _a !== void 0 ? _a : 0) * -this.count.soundCryCount;
            const attackSpeedBoost = ((_b = [0, 5, 5][synergyLevel]) !== null && _b !== void 0 ? _b : 0) * -this.count.soundCryCount;
        ...
        const soundEffect = Synergy_1.SynergyEffects[Synergy_1.Synergy.SOUND].find((effect) => {
            var _a;
            (_a = this.player) === null || _a === void 0 ? void 0 : _a.effects.has(effect);
        });
        if (soundEffect) {
