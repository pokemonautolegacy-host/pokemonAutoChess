...
exports.ItemEffects = {
    ...
    [Item_1.Item.REPEAT_BALL]: [
        new effect_1.OnItemGainedEffect((pokemon) => {
            ...
            pokemon.addShield(Math.floor((((_b = (_a = pokemon.player) === null || _a === void 0 ? void 0 : _a.rerollCount) !== null && _b !== void 0 ? _b : 0) + pokemon.simulation.stageLevel) /
                2) * 2, pokemon, 0, false);
            pokemon.addAttackSpeed(Math.floor((((_d = (_c = pokemon.player) === null || _c === void 0 ? void 0 : _c.rerollCount) !== null && _d !== void 0 ? _d : 0) + pokemon.simulation.stageLevel) /
                2), pokemon, 0, false);
        }),
        new effect_1.OnItemRemovedEffect((pokemon) => {
            var _a, _b;
    ...
    [Item_1.Item.COMFEY]: [
        new effect_1.OnItemGainedEffect((pokemon) => {
            ...
            pokemon.addAttackSpeed(comfey.atkSpeed - Config_1.DEFAULT_ATK_SPEED, pokemon, 0, false);
