...
class Simulation extends schema_1.Schema {
    ...
    applySynergyEffects(pokemon, singleType) {
        ...
        if ((singleType === Synergy_1.Synergy.SOUND ||
            ...
            !Synergy_1.SynergyEffects[Synergy_1.Synergy.SOUND].some((e) => allyEffects.has(e))) {
    ...
    applyEffect(pokemon, types, effect, activeSynergies) {
        switch (effect) {
            ...
            case Effect_1.Effect.WATER_SPRING: {
                pokemon.effectsSet.add(new effect_1.WaterSpringEffect());
                break;
            }
