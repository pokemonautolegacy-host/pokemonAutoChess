...
function displayAbility(scene, pokemonsOnBoard, skill, orientation, positionX, positionY, targetX, targetY, flip, delay) {
    ...
    switch (skill) {
        ...
        case Ability_1.Ability.RAGE:
            addAbilitySprite(Ability_1.Ability.TORMENT, [coordinates[0], coordinates[1] - 50], true).setScale(2);
            break;
        ...
        case Ability_1.Ability.NASTY_PLOT:
            addAbilitySprite(skill, [coordinates[0], coordinates[1] - 50], true).setScale(2);
            break;
