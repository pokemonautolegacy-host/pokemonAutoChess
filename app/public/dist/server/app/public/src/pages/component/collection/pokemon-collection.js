...
function PokemonCollection() {
    ...
    const prevFilterState = (0, react_1.useMemo)(() => {
        ...
        return {
            ...
            refundableOnly: (_d = prevState === null || prevState === void 0 ? void 0 : prevState.refundableOnly) !== null && _d !== void 0 ? _d : false
        };
    }, []);
    ...
    const [refundableOnly, setRefundableOnly] = (0, react_1.useState)(prevFilterState.refundableOnly);
    (0, react_1.useEffect)(() => {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { id: "pokemon-collection", children: [(0, jsx_runtime_1.jsxs)("header", { children: [(0, jsx_runtime_1.jsx)(pokemon_typeahead_1.PokemonTypeahead, { value: selectedPokemon, onChange: setSelectedPokemon }), (0, jsx_runtime_1.jsxs)("select", { value: filter, onChange: (e) => setFilter(e.target.value), children: [(0, jsx_runtime_1.jsx)("option", { value: "all", children: t("show_all") }), (0, jsx_runtime_1.jsx)("option", { value: "locked", children: t("show_locked") }), (0, jsx_runtime_1.jsx)("option", { value: "unlockable", children: t("show_unlockable") }), (0, jsx_runtime_1.jsx)("option", { value: "unlocked", children: t("show_unlocked") })] }), (0, jsx_runtime_1.jsxs)("select", { value: sort, onChange: (e) => setSort(e.target.value), children: [(0, jsx_runtime_1.jsx)("option", { value: "index", children: t("sort_by_index") }), (0, jsx_runtime_1.jsx)("option", { value: "shards", children: t("sort_by_shards") })] }), (0, jsx_runtime_1.jsx)(checkbox_1.Checkbox, { checked: shinyOnly, onToggle: setShinyOnly, label: t("shiny_hunter"), isDark: true }), (0, jsx_runtime_1.jsx)(checkbox_1.Checkbox, { checked: refundableOnly, onToggle: setRefundableOnly, label: t("refundable"), isDark: true })] }), (0, jsx_runtime_1.jsx)("div", { children: (0, jsx_runtime_1.jsxs)(react_tabs_1.Tabs, { children: [(0, jsx_runtime_1.jsxs)(react_tabs_1.TabList, { className: "pokemon-collection-tabs", children: [(0, jsx_runtime_1.jsx)(react_tabs_1.Tab, { children: t("all") }, "title-all"), Object.keys(Synergy_1.Synergy).map((type) => {
                            ...
                            return ((0, jsx_runtime_1.jsx)(react_tabs_1.TabPanel, { children: (0, jsx_runtime_1.jsx)(PokemonCollectionList, { type: type, setPokemon: setSelectedPokemon, filter: filter, sort: sort, shinyOnly: shinyOnly, refundableOnly: refundableOnly }) }, type));
                        }), (0, jsx_runtime_1.jsx)(react_tabs_1.TabPanel, { children: (0, jsx_runtime_1.jsx)(unown_panel_1.default, { setPokemon: setSelectedPokemon, filter: filter, sort: sort, shinyOnly: shinyOnly, refundableOnly: refundableOnly }) })] }) }), selectedPokemon && ((0, jsx_runtime_1.jsx)(pokemon_emotions_modal_1.default, { pokemon: selectedPokemon, onClose: () => setSelectedPokemon("") }))] }));
}
function PokemonCollectionList(props) {
    ...
    const elligiblePokemons = (0, react_1.useMemo)(() => pokemonsSorted.map((pkm) => {
        ...
        if (pkm !== Pokemon_1.Pkm.DEFAULT &&
            ...
            return ((0, jsx_runtime_1.jsx)(pokemon_collection_item_1.default, { name: pkm, index: pokemonData.index, config: getConfig(pokemonData.index), filter: props.filter, shinyOnly: props.shinyOnly, refundableOnly: props.refundableOnly, setPokemon: props.setPokemon }, `${pokemonData.index}-${props.type}`));
        }
        return null;
    }), [
        getConfig,
