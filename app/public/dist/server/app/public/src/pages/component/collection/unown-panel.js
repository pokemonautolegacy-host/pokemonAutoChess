...
function UnownPanel(props) {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("div", { id: "unown-panel", children: secretMessage.map((char, i) => renderChar(char, i, unowns)) }), (0, jsx_runtime_1.jsx)("div", { className: "pokemon-collection-list", children: unowns.map((unown) => {
                    if (!unown)
                        return null;
                    return ((0, jsx_runtime_1.jsx)(pokemon_collection_item_1.default, { name: unown.pkm, index: Pokemon_1.PkmIndex[unown.pkm], config: unown.config, setPokemon: props.setPokemon, filter: props.filter, shinyOnly: props.shinyOnly, refundableOnly: props.refundableOnly }, Pokemon_1.PkmIndex[unown.pkm]));
                }) })] }));
}
