...
export declare function getFirstAvailablePositionInBench(board: MapSchema<Pokemon, string>): number;
export declare function getFirstAvailablePositionOnBoard(board: MapSchema<Pokemon, string>): number[];
